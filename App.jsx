...
function QuizScreen({ onClose, onCoinsEarned, leagueMembers = {}, userId, userName, onUpdateQuizBest, personalBestOverride, onTokenChange, onCardWon }) {
  ...
  const GENERAL_Q = [
    ...
    {q:"מהו קנס?",a:"11 מטר",options:["9 מטר", "11 מטר", "12 מטר", "10 מטר"],cat:"כללי",diff:"קל"},
    ...
    {q:"מהי הפסיקה בכדורגל לשחקן שקיבל 2 כרטיסים צהובים?",a:"אדום",options:["פסילה", "אדום", "קנס כספי", "אזהרה"],cat:"כללי",diff:"קל"},
